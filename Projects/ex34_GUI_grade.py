# GUI 로 성적관리 프로그램 만들기.
# 기능 요구
#1. 사용자로부터 [이름, 국어, 영어, 수학] 점수를 입력 받아야 함.
...
#[5번] 각 버튼들이 클릭 되었을때 수행할 작업코드들을 별도의 함수들로 만들어서 버튼에 적용하기-------------------------
...
def clicked_complete():
    ...
    #총점, 평균 계산 [주의. 모든 사용자 입력은 string 문자열....]
...
def clicked_delete():
    ...
    index= listbox_result.curselection()  # current seclection : 현재 선택
...
#[2번] [이름, 국어, 영어, 수학] 성적을 입력하기 위한 위젯 만들기
...
#[4번] 리스트박스, 항목삭제버튼, csv 파일저장 버튼을 구성하는 영역
