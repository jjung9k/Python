...
btn1.pack(side='left', anchor='n')    # anchor 는 방향을 표시함(n = 남쪽)

btn2= Button(window, text='button #2')
btn2.pack(side='right', fill='y') # fill은 칸을 채울때 사용(y축으로)
...
#2) place : 절대위치,,, 원하는 좌표에 위치 (겹칠수도 있음)
...
#3) grid : 격자(행렬) 배치 --- 게산기 같은 GUI 만들때 용이하다
