...
#requests [외부모듈 - 별도 설치필요(터미널 > pip install)]

import requests
address= 'https://cdn.pixabay.com/photo/2020/12/01/16/11/ornaments-5794746_1280.jpg'  #이미지파일의 인터넷경로
...
#response 응답객체는 본인이 읽어온 바이너리데이터를 16진수로 보여질 수 있음.
print(response.content)
print()

#읽어온 이미지 파일데이터 덩어리를 내 컴퓨터에 파일로 저장하기(파일 처리 표준함수 open() 사용하기 )
